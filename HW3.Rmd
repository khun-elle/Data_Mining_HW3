...
rmsemodels <- c("RMSE CART" = rmse(dengue_cart, dengue_test),
                "RMSE CART Prune" = rmse(dengue_cart_prune, dengue_test), 
                "RMSE Random Forest" = rmse(dengue_forest, dengue_test),
